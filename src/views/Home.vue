          ...
          <v-card class="mb-2 pa-1 borderLeft" color="#4FC694">
            <v-toolbar color="#4FC694" dark flat>
              <v-tabs align-with-title>
                ...
                <v-tab>
                  <v-btn dark icon>
                    <v-bidge content="2" color="orange">
            ...
            <v-list three-line>
              <template v-for="(item) in items">
                ...
                <v-list-item v-else :key="item.title">
                  <v-list-item-avatar color="#EFF4F1" size="70">
      ...
      <h3 class="black--text">$386</h3>
        ...
        <v-col cols="12" sm="3">
          ...
          <v-card class="rounded-xl">
            ...
            <v-app-bar flat color="rgba(0,0,0,0)">
              <v-avatar rounded size="40" class="mr-4">
...
export default {
  data: () => ({
    items: [
      ...
      {
        avatar: '4.png',
        title: '<strong>Capricorn</strong>',
        subtitle: '622 Plants',
        money: '$630'
      },
      {
        avatar: '5.png',
        title: '<strong>Pipal</strong>',
        subtitle: '611 Plants',
        money: '$60'
      },
      {
        avatar: '6.png',
        title: '<strong>Tuslsi</strong>',
        subtitle: '630 Plants',
        money: '$643'
      },
      {
        avatar: '7.png',
        title: '<strong>Sarkar</strong>',
        subtitle: '666 Plants',
        money: '$64'
      },
      {
        avatar: '8.png',
        title: '<strong>Casss</strong>',
        subtitle: '600 Plants',
        money: '$610'
      },
